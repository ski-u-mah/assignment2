...
#with open('df_combined_1.pkl', 'wb') as f:
#    pkl.dump(df_combined_1, f)
...
with open("corpus.pkl", "rb") as corpus: 
    corpus = pkl.load(corpus)
with open("df_combined_1.pkl", "rb") as df_combined_1: 
    df_combined_1 = pkl.load(df_combined_1)
with open("corpus_embeddings.pkl", "rb") as corpus_embeddings: 
    corpus_embeddings = pkl.load(corpus_embeddings)
